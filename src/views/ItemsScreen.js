...
useEffect(() => {
 ...
 const fetchItems = async () => {
  try {
    ...
    const response = await axios.get("https://stokkontrol-production.up.railway.app/store/api/items/", headers);
...
const fetchCategories = async () => {
  try {
    const headers = await getAuthHeaders();
    const response = await axios.get("https://stokkontrol-production.up.railway.app/store/api/categories/", headers);
  ...
  try {
    ...
    if (editingItemId) {
      await axios.put(
        `https://stokkontrol-production.up.railway.app/store/api/items/${editingItemId}/`,
        newItem,
        headers
      );
    } else {
      await axios.post(
        "https://stokkontrol-production.up.railway.app/store/api/items/",
        newItem,
        headers
      );
    }
...
const handleDeleteItem = async (id) => {
  try {
    ...
    await axios.delete(
      `https://stokkontrol-production.up.railway.app/store/api/items/${id}/`,
      headers
    );
    fetchItems();
  } catch (error) {
